...
import { default as BaseService } from '@feathers-service-manager/base-service'
import { default as ConnectionService, ServiceClass } from '../src'

const debug = Debug('feathers-service-manager:connection-service:tests')
